...
import { getUniqueCategories } from '../types/Task';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="">
                    ...
                    <select
                        id="filter"
                        value={filterType}
                        onChange={(e) => onFilterChnage(e.target.value as FilterType)}
                ...
                <div className="">
                    <label htmlFor="categoryFilter" className='block text-sm font-medium text-slate-700 mb-2'>
                        Category
                    </label>
                    <select
                        id="categoryFilter"
